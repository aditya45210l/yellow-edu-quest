...
// import { stablishWebSocketConnection } from "@/lib/NewWebscocket";
...
//       const walletClients = createWalletClient({
//         account: accountData?.address as Address,
//         chain: mainnet,
//         transport: custom(window.ethereum),
//       });
    
//       setWalletClient(walletClients);
      
//       useEffect(() => {
//         setAccount(accountData?.address as Address);
